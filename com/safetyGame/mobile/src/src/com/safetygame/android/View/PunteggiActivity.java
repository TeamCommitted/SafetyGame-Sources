...
public class PunteggiActivity extends SherlockActivity {
    ...
    private class PunteggiTask extends AsyncTask<Object, String, Punteggi>
    {
		...
		protected Punteggi doInBackground(Object... params) {
	        ...
	        Punteggi punteggi = (Punteggi) ConnectionUtils.HttpCreateClient("http://monossido.ath.cx/teamcommitted/backend/API/punteggi.jsp", nameValuePairs);
		...
		protected void onPostExecute(Punteggi punteggi)
		{
			...
			if(punteggi!=null)
	        {
        		...
        		((TextView)findViewById(R.id.Punti)).setText("Risposte date "+punteggi.getRispostedate()+"\nRisposte corrette "+punteggi.getRispostecorrette()+
        				"\nRisposte errate "+punteggi.getRisposteerrate()+
        				"\nPunti "+punteggi.getPunti());
